...
# Your legal name
first_name = "vsspavanakasinadhsarma"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = ""            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "swayampakula"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "6305953487"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Guntur, Andhra Pradesh, India"                  # Los Angeles, San Francisco, etc.
'''
...
street = "A.T Agrharam kankara gunta gate near underbridge"
