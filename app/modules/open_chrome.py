...
from app.modules.helpers import make_directories
from app.config.settings import run_in_background, stealth_mode, disable_extensions, safe_mode, file_name, failed_file_name, logs_folder_path, generated_resume_path
from app.config.questions import default_resume_path
if stealth_mode:
...
from app.modules.helpers import find_default_profile_directory, critical_error_log, print_lg
